...
EbNoVec = (0:1:30)';                                                       %Eb/No VALORES QUE VARIA DE 0 A 15 COM ESPAÇO DE 1 EM 1 (dB), REPRESENTADO EM 15 LINHAS
...
if M==16
semilogy(EbNoVec,berEst,'k-x')                                             %PLOTAGEM DOS PONTOS * NO GRÁFICO
hold on                                                                    %SEGURA O GRÁFICO PARA SOBREPOR PLOTAGEM
grid on                                                                    %LINHAS DE GRADE DO GRÁFICO
legend('4-QAM','16-QAM','32-QAM','64-QAM','128-QAM','256-QAM','1024-QAM')                   %LEGENDA DO GRÁFICO
end
...
if M==256
semilogy(EbNoVec,berEst,'b-x')                                             %PLOTAGEM DOS PONTOS * NO GRÁFICO
hold on                                                                    %SEGURA O GRÁFICO PARA SOBREPOR PLOTAGEM
grid on                                                                    %LINHAS DE GRADE DO GRÁFICO
legend('4-QAM','16-QAM','32-QAM','64-QAM','128-QAM','256-QAM','1024-QAM')  %LEGENDA DO GRÁFICO
end
